...
class FlashcardRepositoryImpl implements FlashcardRepository {
  ...
  Future<FlashcardDeck> generateDeckFromMultimodal({
    ...
    final basePrompt = '''
You are a professional study deck generator.
Brainstorm and generate exactly 20 high-quality flashcards based on the topic provided.
...
Topic to generate flashcards on: $topic
''';

    // Ensure the model engine is initialized and model is installed first
    try {
